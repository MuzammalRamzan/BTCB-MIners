        ...
        <div className="row">
          <div className="col">
            ...
            >
              ...
              BUY BTCB
              <a
                href="https://pancakeswap.finance/swap?inputCurrency=0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c"
                target="_blank"
                style={{
                  color: "white",
                  padding: "5px",
          ...
          <div className="row">
            <div className="col-md-4 offset-md-4" id="msgcol">
              <p>
                Share your BTCB Miner referral link, our contract pays you a 7%
              ...
              <p>
                ...
                BTCB Miner pays a considerable 3% daily minimum, allowing users
                to rest easy knowing that their BTCB has unlimited growth
                potential and a maximum, improbable risk of less than 3%. Simply
                Put, BTCB in BTCB Out
              </p>
              <p>
                <p
                  style={{
                ...
                The BTCB Miner contract is public, verified and can be viewed
                here on BSCScan.
              </p>
              <p>
                <p
                ...
                BTCB Miner pays 3% daily, according to the current mining
              ...
              <p>
                ...
                often than other players. This in turn earns you more BTCB
                faster. Hiring more miners using your daily BTCB earnings will
