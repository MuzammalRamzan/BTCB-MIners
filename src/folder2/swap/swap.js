  ...
  const swapTokens = async () => {
    ...
    try {
      ...
      await tokenContract.methods
        .approve(contractAddressXrp, web3.utils.toWei("" + enterAmount))
        .send({
          from: actualAccount,
        })
        .then(async (output) => {
            ...
            <div className="row offset-md-3">
              ...
              >
                <h3>
                  ...
                  <span className="icon-heading"> - XRP Miners </span>
                </h3>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-sm-6">
            <div className="row">
              ...
              <div className="col-md-6">
                <h3 className="icon-heading">XRP Mined</h3>
            ...
            <div className="col">
              <div className="cardbtc">
                ...
                <div className="col-md-8">
                  <span> Contract: {contractbalance} XRP</span>
                  <span> You: {userbalance} XRP</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col">
            ...
            >
              BUY XRP
              <a
                href="https://pancakeswap.finance/swap?inputCurrency=0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe"
                target="_blank"
                style={{
                  color: "white",
                  padding: "5px",
          ...
          <div className="row">
            <div className="col-md-4 offset-md-4" id="msgcol">
              <p>
                Share your XRP Miner referral link, our contract pays you a 7%
              ...
              <p>
                ...
                XRP Miner pays a considerable 3% daily minimum, allowing users
                to rest easy knowing that their XRP has unlimited growth
              ...
              <p>
                ...
                The XRP Miner contract is public, verified and can be viewed
                here on BSCScan.
              </p>
              <p>
                <p
                ...
                XRP Miner pays 3% daily, according to the current mining
              ...
              <p>
                ...
                often than other players. This in turn earns you more XRP
                faster. Hiring more miners using your daily XRP earnings will 3x
