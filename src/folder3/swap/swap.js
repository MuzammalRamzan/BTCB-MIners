...
function Swap() {
  ...
  const [upline, setUpline] = useState(refDefaultAddressRex);
  ...
  const enterAmountCall = async (e) => {
    try {
      ...
      // try {
      //   let accounts = await getAccounts();
      //   let contract = new web3.eth.Contract(abi, contractAddressRex);
  ...
  const maxClc = async (e) => {
    try {
      if (balance >= 3) {
        ...
        try {
          let accounts = await getAccounts();
          let contract = new web3.eth.Contract(abiRex, contractAddressRex);
  ...
  const swapTokens = async () => {
    ...
    try {
      ...
      let contract = new web3.eth.Contract(abiRex, contractAddressRex);
      let tokenContract = new web3.eth.Contract(tokenAbiRex, tokenAddresRex);
      await tokenContract.methods
        .approve(contractAddressRex, web3.utils.toWei("" + enterAmount))
        .send({
          from: actualAccount,
        })
        .then(async (output) => {
    ...
    try {
      ...
      const wasAdded = window.ethereum.request({
        ...
        params: {
          ...
          options: {
            address: tokenAddresRex, // The address that the token is at.
            ...
            <div className="row offset-md-3">
              ...
              >
                <h3>
                  ...
                  <span className="icon-heading"> - REX Miners </span>
                </h3>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-sm-6">
            <div className="row">
              ...
              <div className="col-md-6">
                <h3 className="icon-heading">REX Mined</h3>
            ...
            <div className="col">
              <div className="cardbtc">
                ...
                <div className="col-md-8">
                  <span> Contract: {contractbalance} REX</span>
                  <span> You: {userbalance} REX</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col">
            ...
            >
              ...
              BUY REX
              <a
                href="https://pancakeswap.finance/swap?inputCurrency=0x5e0b09b04d6990e76dfe9bf84552a940fd0be05e"
                target="_blank"
                style={{
                  color: "white",
                  padding: "5px",
          ...
          <div className="row">
            <div className="col-md-4 offset-md-4" id="msgcol">
              <p>
                Share your REXMiner referral link, our contract pays you a 7%
              ...
              <p>
                ...
                REX Miner pays a considerable 3% daily minimum, allowing users
                to rest easy knowing that their REX has unlimited growth
              ...
              <p>
                ...
                The REX Miner contract is public, verified and can be viewed
                here on BSCScan.
              </p>
              <p>
                <p
                ...
                REX Miner pays 3% daily, according to the current mining
              ...
              <p>
                ...
                often than other players. This in turn earns you more REX
                faster. Hiring more miners using your daily REX earnings will 3x
